...
欢迎来到 **Sora 2 提示词画廊** - 这是一个为 OpenAI 的 Sora 2 AI 模型精心策划的 100 个文本生成视频提示词的综合集合。本仓库展示了 Sora 2 在从文本描述生成高质量视频方面的惊人能力。

### 什么是 Sora 2？

Sora 2 是 OpenAI 的先进文本生成视频 AI 模型，可以根据文本指令创建逼真且富有想象力的场景。它能够理解复杂的物理规律、详细的角色动画，并能生成电影级的视频内容。

## 📊 提示词集合

本集合包括：
- ✨ **20 个官方提示词**来自 [SoraInviteCode.org](https://sorainvitecode.org/prompt)
- 🎨 **80 个额外提示词**来自各种社区来源和创作者
- 🎯 类别：动画、写实场景、奇幻、动作、客串效果等
...
| # | 提示词 | 描述 | 来源 |
|---|--------|------|------|
| 1 | `figure skater performs a triple axle with a cat on her head` | 专业花样滑冰运动员在头顶平衡一只猫的情况下完成完美的三周跳，展示了复杂的物理建模 | [链接](https://sorainvitecode.org/prompt) |
| 7 | `Anime style fireworks festival with vibrant colors` | 美丽的动漫风格烟花表演，呈现惊艳的美学效果 | [链接](https://sorainvitecode.org/prompt) |
| 8 | `A dog in Ghibli animation style exploring a magical forest` | 吉卜力工作室风格的动画，以手绘美学风格展现一只狗 | [链接](https://sorainvitecode.org/prompt) |
| 11 | `A claymation conductor conducts a claymation orchestra` | 迷人的定格动画风格，配有同步音乐 | [链接](https://sorainvitecode.org/prompt) |
| 12 | `Anime character awakening with dramatic lighting and effects` | 电影感的动漫场景，配有戏剧性的灯光和视觉效果 | [链接](https://sorainvitecode.org/prompt) |

### 写实与电影感

| # | 提示词 | 描述 | 来源 |
|---|--------|------|------|
| 2 | `a guy does a backflip` | 在划桨板上进行动态后空翻，准确建模水中的浮力和刚性物理 | [链接](https://sorainvitecode.org/prompt) |
| 3 | `Vikings Go To War — North Sea Launch (10.0s, Winter cool daylight / early medieval). Clinker-built longships push off from a frozen shore` | 维京战士将长船推入寒冷的北海的史诗电影场景 | [链接](https://sorainvitecode.org/prompt) |
| 4 | `Two mountain explorers in bright technical shells, ice crusted faces, eyes narrowed with urgency shout in the snow, one at a time` | 逼真的山地探险场景，配有同步对话和逼真的风雪音效 | [链接](https://sorainvitecode.org/prompt) |
| 13 | `Academic setting with students in a prestigious university` | 具有自然光线和氛围的逼真学术环境 | [链接](https://sorainvitecode.org/prompt) |
| 21 | `A stylish woman walks down a Tokyo street filled with warm glowing neon and animated city signage. She wears a black leather jacket, a long red dress, and black boots, and carries a black purse. She wears sunglasses and red lipstick. She walks confidently and casually. The street is damp and reflective, creating a mirror effect of the colorful lights. Many pedestrians walk about.` | 标志性的东京街景，配有逼真的光线和倒影 | [社区](https://www.gptschat.one/sora/sora_prompts.html) |
| 22 | `Several giant wooly mammoths approach treading through a snowy meadow, their long wooly fur lightly blows in the wind as they walk, snow covered trees and dramatic snow capped mountains in the distance, mid afternoon light with wispy clouds and a sun high in the distance creates a warm glow, the low camera view is stunning capturing the large furry mammal with beautiful photography, depth of field.` | 史前场景，详细的毛发物理和电影摄影 | [社区](https://www.gptschat.one/sora/sora_prompts.html) |

### 奇幻与生物

| # | 提示词 | 描述 | 来源 |
|---|--------|------|------|
| 5 | `Bigfoot is really kind to him, a little too kind, like oddly kind. Bigfoot wants to hang out but he wants to hang too much` | 幽默场景，配有逼真的生物动画和语音 | [链接](https://sorainvitecode.org/prompt) |
| 6 | `An astronaut golden retriever named 'Sora' levitates around an intergalactic pup-themed space station` | 奇妙的太空冒险，配有多彩的环境 | [链接](https://sorainvitecode.org/prompt) |
| 9 | `A dragon slicing past serrated ice spires, wingtip vortices peeling spindrift. The glacier's fractured sheet falls away to a cobalt fjord, with amber sun rim kissing frost on scales` | 史诗般的龙飞行，详细的风和冰粒物理 | [链接](https://sorainvitecode.org/prompt) |
| 10 | `A Dalmatian performing Olympic gymnastics routines` | 斑点狗执行复杂的体操动作，先进的物理模拟 | [链接](https://sorainvitecode.org/prompt) |

### 客串功能

| # | 提示词 | 描述 | 来源 |
|---|--------|------|------|
| 14 | `Person with cameo in a magical fantasy setting` | 真实人物插入到奇幻生成环境中 | [链接](https://sorainvitecode.org/prompt) |
| 15 | `Real person cameo in an action scene` | 人物无缝地置于动作场景中 | [链接](https://sorainvitecode.org/prompt) |
| 16 | `Person exploring a surreal dreamlike environment` | 梦幻般的超现实环境中的客串，配有创意效果 | [链接](https://sorainvitecode.org/prompt) |
| 17 | `Person in a vibrant urban cyberpunk setting` | 真实人物融入未来主义赛博朋克城市景观 | [链接](https://sorainvitecode.org/prompt) |
| 18 | `Adventure scene in an exotic jungle location` | 郁郁葱葱的丛林中的人物，配有逼真的光线和植被 | [链接](https://sorainvitecode.org/prompt) |
| 19 | `Warm and inviting winter cabin scene with realistic lighting and atmosphere` | 舒适的冬季小屋场景，配有逼真的氛围 | [链接](https://sorainvitecode.org/prompt) |
| 20 | `Person in an underwater oceanic environment` | 令人惊叹的水下场景，配有详细的海洋环境 | [链接](https://sorainvitecode.org/prompt) |

## 📋 完整提示词表格

| # | 提示词 | 效果描述 | 来源 |
|---|--------|---------|------|
| 1 | `figure skater performs a triple axle with a cat on her head` | 专业花样滑冰运动员在头顶平衡一只猫的情况下完成完美的三周跳，展示了复杂的物理和不可能场景 | [链接](https://sorainvitecode.org/prompt) |
| 2 | `a guy does a backflip` | 人在划桨板上进行动态后空翻，准确建模水中浮力和刚性的物理 | [链接](https://sorainvitecode.org/prompt) |
| 3 | `Vikings Go To War — North Sea Launch (10.0s, Winter cool daylight / early medieval). Clinker-built longships push off from a frozen shore` | 维京战士将长船推入寒冷北海的史诗电影场景 | [链接](https://sorainvitecode.org/prompt) |
| 4 | `Two mountain explorers in bright technical shells, ice crusted faces, eyes narrowed with urgency shout in the snow, one at a time` | 逼真的山地探险场景，配有同步对话和逼真的风雪音效 | [链接](https://sorainvitecode.org/prompt) |
| 5 | `Bigfoot is really kind to him, a little too kind, like oddly kind. Bigfoot wants to hang out but he wants to hang too much` | 幽默场景，大脚怪配有逼真的生物动画和同步语音 | [链接](https://sorainvitecode.org/prompt) |
| 6 | `An astronaut golden retriever named 'Sora' levitates around an intergalactic pup-themed space station` | 奇妙的太空冒险，金毛猎犬在多彩的空间站中 | [链接](https://sorainvitecode.org/prompt) |
| 7 | `Anime style fireworks festival with vibrant colors` | 美丽的动漫风格烟花表演，呈现惊艳的美学 | [链接](https://sorainvitecode.org/prompt) |
| 8 | `A dog in Ghibli animation style exploring a magical forest` | 吉卜力工作室风格的动画，手绘美学风格 | [链接](https://sorainvitecode.org/prompt) |
| 9 | `A dragon slicing past serrated ice spires, wingtip vortices peeling spindrift. The glacier's fractured sheet falls away to a cobalt fjord, with amber sun rim kissing frost on scales` | 穿过冰山的史诗电影龙飞行，详细的物理效果 | [链接](https://sorainvitecode.org/prompt) |
| 10 | `A Dalmatian performing Olympic gymnastics routines` | 斑点狗执行复杂的体操动作，先进的物理模拟 | [链接](https://sorainvitecode.org/prompt) |
| 11 | `A claymation conductor conducts a claymation orchestra` | 迷人的定格动画风格，配有同步音乐 | [链接](https://sorainvitecode.org/prompt) |
| 12 | `Anime character awakening with dramatic lighting and effects` | 电影感的动漫场景，配有戏剧性的灯光和视觉效果 | [链接](https://sorainvitecode.org/prompt) |
| 13 | `Academic setting with students in a prestigious university` | 学术环境中的逼真电影场景，配有自然光线 | [链接](https://sorainvitecode.org/prompt) |
| 14 | `Person with cameo in a magical fantasy setting` | 客串功能将真实人物插入奇幻环境 | [链接](https://sorainvitecode.org/prompt) |
| 15 | `Real person cameo in an action scene` | 客串技术将人物无缝置于动作场景 | [链接](https://sorainvitecode.org/prompt) |
| 16 | `Person exploring a surreal dreamlike environment` | 梦幻般的超现实环境中的客串，配有创意视觉效果 | [链接](https://sorainvitecode.org/prompt) |
| 17 | `Person in a vibrant urban cyberpunk setting` | 真实人物融入未来主义赛博朋克城市景观，配有霓虹灯 | [链接](https://sorainvitecode.org/prompt) |
| 18 | `Adventure scene in an exotic jungle location` | 郁郁葱葱的丛林环境中的客串，配有逼真的光线和植被 | [链接](https://sorainvitecode.org/prompt) |
| 19 | `Warm and inviting winter cabin scene with realistic lighting and atmosphere` | 舒适的冬季小屋场景，使用客串技术配有逼真的光线 | [链接](https://sorainvitecode.org/prompt) |
...
| 41 | `A close up view of a papercraft underwater scene. A blue whale swims through the frame, with cardboard fish and sea creatures drifting alongside it.` | 手工纸艺艺术风格，配有水下主题 | [社区](https://openai.com/sora) |
...
| 90 | `A street artist creating a massive chalk drawing on pavement, aerial view shows the incredible detail and scale. Passersby stop to watch and photograph. The artwork is a trompe-l'oeil creating illusion of 3D depth. Creative, impressive, temporary art.` | 街头艺术创作，配有航拍视角和 3D 错觉 | [社区](https://www.dongaigc.com) |
