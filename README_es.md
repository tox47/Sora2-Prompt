...
Bienvenido a la **Galería de Prompts de Sora 2** - una colección completa de 100 prompts seleccionados de texto a video para el modelo de IA Sora 2 de OpenAI. Este repositorio muestra las increíbles capacidades de Sora 2 para generar videos de alta calidad a partir de descripciones de texto.
...
- ✨ **20 prompts oficiales** de [SoraInviteCode.org](https://sorainvitecode.org/prompt)
- 🎨 **80 prompts adicionales** de varias fuentes comunitarias y creadores
- 🎯 Categorías: Animación, Escenas Realistas, Fantasía, Acción, Efectos Cameo y más

## 🎥 Prompts Destacados

### Animación y Estilo Anime

| # | Prompt | Descripción | Fuente |
|---|--------|-------------|--------|
| 1 | `figure skater performs a triple axle with a cat on her head` | Patinadora artística profesional ejecutando un salto triple axel perfecto con un gato equilibrado en su cabeza, demostrando modelado físico complejo | [Enlace](https://sorainvitecode.org/prompt) |
| 7 | `Anime style fireworks festival with vibrant colors` | Hermoso espectáculo de fuegos artificiales estilo anime con estética impresionante | [Enlace](https://sorainvitecode.org/prompt) |
| 8 | `A dog in Ghibli animation style exploring a magical forest` | Animación inspirada en Studio Ghibli con un perro en estilo estético dibujado a mano | [Enlace](https://sorainvitecode.org/prompt) |
| 11 | `A claymation conductor conducts a claymation orchestra` | Encantadora animación stop-motion con música sincronizada | [Enlace](https://sorainvitecode.org/prompt) |
| 12 | `Anime character awakening with dramatic lighting and effects` | Escena de anime cinematográfica con iluminación dramática y efectos visuales | [Enlace](https://sorainvitecode.org/prompt) |

### Realista y Cinematográfico

| # | Prompt | Descripción | Fuente |
|---|--------|-------------|--------|
| 2 | `a guy does a backflip` | Salto mortal dinámico en paddleboard, modelando física de flotabilidad y rigidez | [Enlace](https://sorainvitecode.org/prompt) |
| 3 | `Vikings Go To War — North Sea Launch (10.0s, Winter cool daylight / early medieval). Clinker-built longships push off from a frozen shore` | Escena cinematográfica épica de guerreros vikingos lanzando sus drakkars | [Enlace](https://sorainvitecode.org/prompt) |
| 4 | `Two mountain explorers in bright technical shells, ice crusted faces, eyes narrowed with urgency shout in the snow, one at a time` | Exploración de montaña realista con diálogo sincronizado y efectos de sonido | [Enlace](https://sorainvitecode.org/prompt) |
| 13 | `Academic setting with students in a prestigious university` | Ambiente académico realista con iluminación y atmósfera natural | [Enlace](https://sorainvitecode.org/prompt) |
...
| # | Prompt | Descripción | Fuente |
|---|--------|-------------|--------|
| 5 | `Bigfoot is really kind to him, a little too kind, like oddly kind. Bigfoot wants to hang out but he wants to hang too much` | Escena humorística con animación realista de criaturas y habla | [Enlace](https://sorainvitecode.org/prompt) |
| 6 | `An astronaut golden retriever named 'Sora' levitates around an intergalactic pup-themed space station` | Aventura espacial fantasiosa con entornos coloridos | [Enlace](https://sorainvitecode.org/prompt) |
| 9 | `A dragon slicing past serrated ice spires, wingtip vortices peeling spindrift. The glacier's fractured sheet falls away to a cobalt fjord, with amber sun rim kissing frost on scales` | Vuelo épico de dragón con física detallada de viento y partículas de hielo | [Enlace](https://sorainvitecode.org/prompt) |
| 10 | `A Dalmatian performing Olympic gymnastics routines` | Perro ejecutando movimientos gimnásticos complejos con simulación física avanzada | [Enlace](https://sorainvitecode.org/prompt) |

### Efectos Cameo

| # | Prompt | Descripción | Fuente |
|---|--------|-------------|--------|
| 14 | `Person with cameo in a magical fantasy setting` | Persona real insertada en entorno generado fantástico | [Enlace](https://sorainvitecode.org/prompt) |
| 15 | `Real person cameo in an action scene` | Persona colocada sin fisuras en escenario de acción | [Enlace](https://sorainvitecode.org/prompt) |
| 16 | `Person exploring a surreal dreamlike environment` | Cameo en entorno onírico y surrealista con efectos creativos | [Enlace](https://sorainvitecode.org/prompt) |
| 17 | `Person in a vibrant urban cyberpunk setting` | Persona real integrada en paisaje urbano cyberpunk futurista | [Enlace](https://sorainvitecode.org/prompt) |
| 18 | `Adventure scene in an exotic jungle location` | Cameo en entorno de jungla con iluminación y vegetación realistas | [Enlace](https://sorainvitecode.org/prompt) |
| 19 | `Warm and inviting winter cabin scene with realistic lighting and atmosphere` | Acogedora escena de cabaña invernal con iluminación realista | [Enlace](https://sorainvitecode.org/prompt) |
| 20 | `Person in an underwater oceanic environment` | Impresionante escena submarina con entorno oceánico detallado | [Enlace](https://sorainvitecode.org/prompt) |

## 📋 Tabla Completa de Prompts

| # | Prompt | Descripción del Efecto | Fuente |
|---|--------|----------------------|--------|
| 1 | `figure skater performs a triple axle with a cat on her head` | Patinadora artística profesional ejecutando un salto triple axel perfecto mientras un gato se equilibra en su cabeza, demostrando física compleja y escenarios imposibles | [Enlace](https://sorainvitecode.org/prompt) |
| 2 | `a guy does a backflip` | Persona realizando un salto mortal dinámico en paddleboard, modelando con precisión la física de flotabilidad y rigidez en el agua | [Enlace](https://sorainvitecode.org/prompt) |
| 3 | `Vikings Go To War — North Sea Launch (10.0s, Winter cool daylight / early medieval). Clinker-built longships push off from a frozen shore` | Escena cinematográfica épica de guerreros vikingos lanzando sus drakkars al frío Mar del Norte | [Enlace](https://sorainvitecode.org/prompt) |
| 4 | `Two mountain explorers in bright technical shells, ice crusted faces, eyes narrowed with urgency shout in the snow, one at a time` | Escena realista de exploración de montaña con diálogo sincronizado y efectos de sonido realistas de viento y hielo | [Enlace](https://sorainvitecode.org/prompt) |
| 5 | `Bigfoot is really kind to him, a little too kind, like oddly kind. Bigfoot wants to hang out but he wants to hang too much` | Escena humorística con Bigfoot con animación realista de criatura y habla sincronizada | [Enlace](https://sorainvitecode.org/prompt) |
| 6 | `An astronaut golden retriever named 'Sora' levitates around an intergalactic pup-themed space station` | Aventura espacial fantasiosa con un golden retriever en una estación espacial colorida | [Enlace](https://sorainvitecode.org/prompt) |
| 7 | `Anime style fireworks festival with vibrant colors` | Hermoso espectáculo de fuegos artificiales estilo anime con estética impresionante | [Enlace](https://sorainvitecode.org/prompt) |
| 8 | `A dog in Ghibli animation style exploring a magical forest` | Animación inspirada en Studio Ghibli con estilo estético dibujado a mano | [Enlace](https://sorainvitecode.org/prompt) |
| 9 | `A dragon slicing past serrated ice spires, wingtip vortices peeling spindrift. The glacier's fractured sheet falls away to a cobalt fjord, with amber sun rim kissing frost on scales` | Vuelo de dragón cinematográfico épico a través de montañas heladas con física detallada | [Enlace](https://sorainvitecode.org/prompt) |
| 10 | `A Dalmatian performing Olympic gymnastics routines` | Perro ejecutando movimientos gimnásticos complejos con simulación física avanzada | [Enlace](https://sorainvitecode.org/prompt) |
| 11 | `A claymation conductor conducts a claymation orchestra` | Encantadora animación stop-motion con música sincronizada | [Enlace](https://sorainvitecode.org/prompt) |
| 12 | `Anime character awakening with dramatic lighting and effects` | Escena de anime cinematográfica con iluminación dramática y efectos visuales | [Enlace](https://sorainvitecode.org/prompt) |
| 13 | `Academic setting with students in a prestigious university` | Escena cinematográfica realista en entorno académico con iluminación natural | [Enlace](https://sorainvitecode.org/prompt) |
| 14 | `Person with cameo in a magical fantasy setting` | Función cameo insertando persona real en entorno fantástico | [Enlace](https://sorainvitecode.org/prompt) |
| 15 | `Real person cameo in an action scene` | Tecnología cameo colocando persona sin fisuras en escenario de acción | [Enlace](https://sorainvitecode.org/prompt) |
| 16 | `Person exploring a surreal dreamlike environment` | Cameo en entorno onírico y surrealista con efectos visuales creativos | [Enlace](https://sorainvitecode.org/prompt) |
