...
Добро пожаловать в **Галерея промптов Sora 2** - una всеобъемлющую коллекцию de 100 prompts seleccionados de texto a video para el modelo de IA Sora 2 de OpenAI. Este repositorio muestra las increíbles capacidades de Sora 2 para generar videos de alta calidad a partir de descripciones de texto.
...
- ✨ **20 официальных промптов** de [SoraInviteCode.org](https://sorainvitecode.org/prompt)
- 🎨 **80 дополнительных промптов** de varias источников сообщества y creadores
- 🎯 Categorías: Animación, Escenas Realistas, Fantasía, Acción, Efectos Cameo y más

## 🎥 Избранные промпты

### Анимация и стиль аниме

| # | Prompt | Описание | Источник |
|---|--------|-------------|--------|
| 1 | `figure skater performs a triple axle with a cat on her head` | Patinadora artística profesional ejecutando un salto triple axel perfecto con un gato equilibrado en su cabeza, demostrando modelado físico complejo | [Ссылка](https://sorainvitecode.org/prompt) |
| 7 | `Anime style fireworks festival with vibrant colors` | Hermoso espectáculo de fuegos artificiales estilo anime con estética impresionante | [Ссылка](https://sorainvitecode.org/prompt) |
| 8 | `A dog in Ghibli animation style exploring a magical forest` | Animación inspirada en Studio Ghibli con un perro en estilo estético dibujado a mano | [Ссылка](https://sorainvitecode.org/prompt) |
| 11 | `A claymation conductor conducts a claymation orchestra` | Encantadora animación stop-motion con música sincronizada | [Ссылка](https://sorainvitecode.org/prompt) |
| 12 | `Anime character awakening with dramatic lighting and effects` | Escena de anime cinematográfica con iluminación dramática y efectos visuales | [Ссылка](https://sorainvitecode.org/prompt) |

### Реалистичный и кинематографический

| # | Prompt | Описание | Источник |
|---|--------|-------------|--------|
| 2 | `a guy does a backflip` | Salto mortal dinámico en paddleboard, modelando física de flotabilidad y rigidez | [Ссылка](https://sorainvitecode.org/prompt) |
| 3 | `Vikings Go To War — North Sea Launch (10.0s, Winter cool daylight / early medieval). Clinker-built longships push off from a frozen shore` | Escena cinematográfica épica de guerreros vikingos lanzando sus drakkars | [Ссылка](https://sorainvitecode.org/prompt) |
| 4 | `Two mountain explorers in bright technical shells, ice crusted faces, eyes narrowed with urgency shout in the snow, one at a time` | Exploración de montaña realista con diálogo sincronizado y efectos de sonido | [Ссылка](https://sorainvitecode.org/prompt) |
| 13 | `Academic setting with students in a prestigious university` | Ambiente académico realista con iluminación y atmósfera natural | [Ссылка](https://sorainvitecode.org/prompt) |
| 21 | `A stylish woman walks down a Tokyo street filled with warm glowing neon and animated city signage. She wears a black leather jacket, a long red dress, and black boots, and carries a black purse. She wears sunglasses and red lipstick. She walks confidently and casually. The street is damp and reflective, creating a mirror effect of the colorful lights. Many pedestrians walk about.` | Icónica escena callejera de Tokio con iluminación y reflejos realistas | [Сообщество](https://www.gptschat.one/sora/sora_prompts.html) |
| 22 | `Several giant wooly mammoths approach treading through a snowy meadow, their long wooly fur lightly blows in the wind as they walk, snow covered trees and dramatic snow capped mountains in the distance, mid afternoon light with wispy clouds and a sun high in the distance creates a warm glow, the low camera view is stunning capturing the large furry mammal with beautiful photography, depth of field.` | Escena prehistórica con física detallada del pelaje y fotografía cinematográfica | [Сообщество](https://www.gptschat.one/sora/sora_prompts.html) |

### Фэнтези и существа

| # | Prompt | Описание | Источник |
|---|--------|-------------|--------|
| 5 | `Bigfoot is really kind to him, a little too kind, like oddly kind. Bigfoot wants to hang out but he wants to hang too much` | Escena humorística con animación realista de criaturas y habla | [Ссылка](https://sorainvitecode.org/prompt) |
| 6 | `An astronaut golden retriever named 'Sora' levitates around an intergalactic pup-themed space station` | Aventura espacial fantasiosa con entornos coloridos | [Ссылка](https://sorainvitecode.org/prompt) |
| 9 | `A dragon slicing past serrated ice spires, wingtip vortices peeling spindrift. The glacier's fractured sheet falls away to a cobalt fjord, with amber sun rim kissing frost on scales` | Vuelo épico de dragón con física detallada de viento y partículas de hielo | [Ссылка](https://sorainvitecode.org/prompt) |
| 10 | `A Dalmatian performing Olympic gymnastics routines` | Perro ejecutando movimientos gimnásticos complejos con simulación física avanzada | [Ссылка](https://sorainvitecode.org/prompt) |

### Эффекты камео

| # | Prompt | Описание | Источник |
|---|--------|-------------|--------|
| 14 | `Person with cameo in a magical fantasy setting` | Persona real insertada en entorno generado fantástico | [Ссылка](https://sorainvitecode.org/prompt) |
| 15 | `Real person cameo in an action scene` | Persona colocada sin fisuras en escenario de acción | [Ссылка](https://sorainvitecode.org/prompt) |
| 16 | `Person exploring a surreal dreamlike environment` | Cameo en entorno onírico y surrealista con efectos creativos | [Ссылка](https://sorainvitecode.org/prompt) |
| 17 | `Person in a vibrant urban cyberpunk setting` | Persona real integrada en paisaje urbano cyberpunk futurista | [Ссылка](https://sorainvitecode.org/prompt) |
| 18 | `Adventure scene in an exotic jungle location` | Cameo en entorno de jungla con iluminación y vegetación realistas | [Ссылка](https://sorainvitecode.org/prompt) |
| 19 | `Warm and inviting winter cabin scene with realistic lighting and atmosphere` | Acogedora escena de cabaña invernal con iluminación realista | [Ссылка](https://sorainvitecode.org/prompt) |
| 20 | `Person in an underwater oceanic environment` | Impresionante escena submarina con entorno oceánico detallado | [Ссылка](https://sorainvitecode.org/prompt) |

## 📋 Полная таблица промптов

| # | Prompt | Описание del Efecto | Источник |
|---|--------|----------------------|--------|
| 1 | `figure skater performs a triple axle with a cat on her head` | Patinadora artística profesional ejecutando un salto triple axel perfecto mientras un gato se equilibra en su cabeza, demostrando física compleja y escenarios imposibles | [Ссылка](https://sorainvitecode.org/prompt) |
| 2 | `a guy does a backflip` | Persona realizando un salto mortal dinámico en paddleboard, modelando con precisión la física de flotabilidad y rigidez en el agua | [Ссылка](https://sorainvitecode.org/prompt) |
| 3 | `Vikings Go To War — North Sea Launch (10.0s, Winter cool daylight / early medieval). Clinker-built longships push off from a frozen shore` | Escena cinematográfica épica de guerreros vikingos lanzando sus drakkars al frío Mar del Norte | [Ссылка](https://sorainvitecode.org/prompt) |
| 4 | `Two mountain explorers in bright technical shells, ice crusted faces, eyes narrowed with urgency shout in the snow, one at a time` | Escena realista de exploración de montaña con diálogo sincronizado y efectos de sonido realistas de viento y hielo | [Ссылка](https://sorainvitecode.org/prompt) |
| 5 | `Bigfoot is really kind to him, a little too kind, like oddly kind. Bigfoot wants to hang out but he wants to hang too much` | Escena humorística con Bigfoot con animación realista de criatura y habla sincronizada | [Ссылка](https://sorainvitecode.org/prompt) |
| 6 | `An astronaut golden retriever named 'Sora' levitates around an intergalactic pup-themed space station` | Aventura espacial fantasiosa con un golden retriever en una estación espacial colorida | [Ссылка](https://sorainvitecode.org/prompt) |
| 7 | `Anime style fireworks festival with vibrant colors` | Hermoso espectáculo de fuegos artificiales estilo anime con estética impresionante | [Ссылка](https://sorainvitecode.org/prompt) |
| 8 | `A dog in Ghibli animation style exploring a magical forest` | Animación inspirada en Studio Ghibli con estilo estético dibujado a mano | [Ссылка](https://sorainvitecode.org/prompt) |
| 9 | `A dragon slicing past serrated ice spires, wingtip vortices peeling spindrift. The glacier's fractured sheet falls away to a cobalt fjord, with amber sun rim kissing frost on scales` | Vuelo de dragón cinematográfico épico a través de montañas heladas con física detallada | [Ссылка](https://sorainvitecode.org/prompt) |
| 10 | `A Dalmatian performing Olympic gymnastics routines` | Perro ejecutando movimientos gimnásticos complejos con simulación física avanzada | [Ссылка](https://sorainvitecode.org/prompt) |
| 11 | `A claymation conductor conducts a claymation orchestra` | Encantadora animación stop-motion con música sincronizada | [Ссылка](https://sorainvitecode.org/prompt) |
| 12 | `Anime character awakening with dramatic lighting and effects` | Escena de anime cinematográfica con iluminación dramática y efectos visuales | [Ссылка](https://sorainvitecode.org/prompt) |
| 13 | `Academic setting with students in a prestigious university` | Escena cinematográfica realista en entorno académico con iluminación natural | [Ссылка](https://sorainvitecode.org/prompt) |
| 14 | `Person with cameo in a magical fantasy setting` | Función cameo insertando persona real en entorno fantástico | [Ссылка](https://sorainvitecode.org/prompt) |
| 15 | `Real person cameo in an action scene` | Tecnología cameo colocando persona sin fisuras en escenario de acción | [Ссылка](https://sorainvitecode.org/prompt) |
| 16 | `Person exploring a surreal dreamlike environment` | Cameo en entorno onírico y surrealista con efectos visuales creativos | [Ссылка](https://sorainvitecode.org/prompt) |
...
| 35 | `A petri dish with a bamboo forest growing within it that has tiny red pandas running around.` | Ecosistema en miniatura surrealista combinando naturaleza y elementos fantásticos | [Сообщество](https://openai.com/sora) |
...
| 51 | `A flock of paper airplanes flutters through a dense jungle, weaving around trees as if they were migrating birds.` | Escena natural surrealista con elementos animados de papel | [Сообщество](https://openai.com/sora) |
